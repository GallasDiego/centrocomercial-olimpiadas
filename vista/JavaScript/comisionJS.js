...
forms = new Array("formGastos","formComision");//Array con los id de todos los formularios
var formulario = "";
...
function enviarFormulario() 
{
  ...
  conexion.onreadystatechange = function(){
    if (conexion.readyState==4){
      document.getElementById("tablaComision").innerHTML=conexion.responseText;
    }
    else{ 
  ...
  conexion.open('POST','../../../../negocio/Ventas.php', true);
